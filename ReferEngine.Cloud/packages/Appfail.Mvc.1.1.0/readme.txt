...
3. If you are using MVC3 with custom errors enabled, an extra configuration step is required. See the following URL for more details:
http://support.appfail.net/kb/installation/appfail-in-mvc3-with-custom-errors-enabled
