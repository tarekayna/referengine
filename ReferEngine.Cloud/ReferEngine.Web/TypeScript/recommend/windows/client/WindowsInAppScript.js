define(["require", "exports", "./../../common/Messaging"], function(require, exports, __Messaging__) {
    ...
    (function (ReferEngine) {
        ...
        function registerMessageHandlers() {
            messenger.addMessageHandler("navigate", function (details) {
                Dom.iframe.src = details.url;
            });
            messenger.addMessageHandler("show-loading", function (details) {
                Loading.show();
            });
            messenger.addMessageHandler("hide-loading", function (details) {
                Loading.hide();
            });
            messenger.addMessageHandler("set-loading-text", function (details) {
                Loading.setText(details.text);
            });
            messenger.addMessageHandler("set-auto-ask", function (details) {
                AutoShow.autoAskAgain = details.askAgain;
            });
            messenger.addMessageHandler("hide", function (details) {
                ReferEngine.hide();
            });
            messenger.addMessageHandler("auth-app", function (details) {
            ...
            messenger.addMessageHandler("fb-login", function (details) {
                Auth.authorizeFacebookAsync().then(function (authResult) {
                    messenger.send(new Messaging.Message("fb-login-result", {
                        authResult: authResult
                    }));
                });
            });
            messenger.addMessageHandler("intro-page-loaded", function (details) {
                introHasLoaded = true;
            });
        }
