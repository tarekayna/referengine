...
define('../common/Messaging',["require", "exports"], function(require, exports) {
    ...
    var Messenger = (function () {
        ...
        Messenger.prototype.sendTextMessage = function (text) {
            this.send(new Message(text));
        };
        Messenger.prototype.receive = function (event) {
            if(event.origin === this.receiveOrigin) {
                ...
                for(var i = 0; i < this.messageHandlers.length; i++) {
                    if(this.messageHandlers[i].msg === message.msg) {
...
;
define('WindowsClientScript',["require", "exports", "../common/Messaging", "../common/Functions"], function(require, exports, __Messaging__, __Functions__) {
