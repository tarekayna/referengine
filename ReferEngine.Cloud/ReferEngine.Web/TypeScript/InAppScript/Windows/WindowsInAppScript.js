...
(function (ReferEngine) {
    ...
    var Auth = (function () {
        function Auth() { }
        Auth.authFacebookAsync = function authFacebookAsync() {
    ...
    function show() {
        if(verifyInternetConnection()) {
            ...
            WinJS.UI.Animation.fadeIn(DomElements.container).then(function () {
                util.removeClass(DomElements.container, hiddenClassName);
            });
        }
    }
    ...
    function hide() {
        WinJS.UI.Animation.fadeOut(DomElements.container).then(function () {
            util.addClass(DomElements.container, hiddenClassName);
        });
    }
