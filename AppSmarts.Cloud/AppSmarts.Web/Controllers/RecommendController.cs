...
using AppSmarts.Web.Models.Recommend.Win8;
...
namespace AppSmarts.Web.Controllers
{
    ...
    public class RecommendController : BaseController
    {
        ...
        public ActionResult AuthorizeAppCode(string platform, string appReceiptXml, string appVerificationCode)
        {
            ...
            Verifier.IsNotNullOrEmpty(appVerificationCode, "appVerificationCode");
            ...
            if (node != null && node.Attributes != null)
            {
                ...
                if (appReceiptNode != null && appReceiptNode.Attributes != null)
                {
                    ...
                    {
                        return new HttpNotFoundResult("Could not find app. Your app must be registered under your account at www.appSmarts.com and Autorization Code must be properly set in appSmarts.Initialize.js.");
                    }
                    ...
                    bool locationIsSupported = Util.CurrentServiceConfiguration == Util.AppSmartsServiceConfiguration.Local;
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult AuthorizeApp(string platform, string appReceiptXml)
        {
            // The only app that is allowed to not have an authorization code is 
           ...
           int end = requestBody.IndexOf("</Receipt>", 0, StringComparison.OrdinalIgnoreCase) + 10;
            ...
            if (start != -1 && end != -1)
            {
                ...
                return AuthorizeAppCode(platform, appReceiptXmlStr, "osidajlsdhfs98ru4ew9pofjpoeslkjfsnfsnfsd");
            }
