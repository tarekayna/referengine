...
declare module WinJS {
    ...
    export function xhr(options: any): WinJS.Promise;
    ...
    export module Utilities {
        ...
        export function addClass(elem: HTMLElement, name: string): HTMLElement;
        export function removeClass(elem: HTMLElement, name: string): HTMLElement;
        export enum Key {
            backspace = 8,
            tab = 9,
            enter = 13,
