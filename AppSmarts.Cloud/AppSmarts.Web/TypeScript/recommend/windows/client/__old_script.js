(function () {
    ...
    var authorizeFacebookAsync = function () {
        return new WinJS.Promise(function (comp, error, prog) {
            ...
            var query = "client_id=" + referEngineFacebookAppId + "&redirect_uri=" + callback + "&scope=" + scope + "&display=popup&response_type=code";
    ...
    var initializeUi = function () {
        ...
        style.innerText = ReferEngine.Style;
        style.type = "text/css";
